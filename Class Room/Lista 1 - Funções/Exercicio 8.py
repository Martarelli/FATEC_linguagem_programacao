...
def duracao_jogo():
    ...
    if hora_inicio <= hora_termino and minuto_inicio <= minuto_termino:
        ...
        if hora_min == 0 and minuto_inicio == minuto_termino:
            hora_min = 24 * 60;
            print("O jogo durou %i minutos"%hora_min);
        elif hora_min == 0 and minuto_inicio < minuto_termino:
            print("O jogo durou mais de 24hrs...");
        else:
